      ...
      <div className="entry" style={{ gridColumn: '1 / -1', marginTop: '40px' }}>
       ...
       <h3>Research Intern<span style={{ fontSize: '0.8em', fontWeight: '300', float: 'right' }}>June 2026 &ndash; Present</span></h3>
        ...
        <ul>
          ...
          <li>Analyzing executive composition and hierarchies to identify leadership patterns, governance trends, and strategic structures.</li>
          <li>Managing and analyzing 2TB+ of large-scale professional and workforce data, performing data cleaning, deduplication, career-trajectory mapping, and seniority-level aggregation to uncover labor market and organizational insights.</li>
        </ul>
        <hr />
        ...
        <ul>
          ...
          <li>Improved applicant conversion across the admissions funnel by serving as the <b>primary point of contact for prospective students</b> and coordinating structured follow-ups with the admissions team.</li>
        </ul>
        <hr />
      </div>
    </div>
